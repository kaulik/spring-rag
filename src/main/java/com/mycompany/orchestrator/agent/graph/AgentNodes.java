package com.mycompany.orchestrator.agent.graph;
...
import com.mycompany.orchestrator.tool.stock.StockLoopCapAdvisor;
import com.mycompany.orchestrator.tool.stock.StockPrompts;
...
public class AgentNodes {
    ...
    static final String ROUTER_SYSTEM_PROMPT =
            ...
            "KNOWLEDGE_BASE - documents, policies, Indices\n" +
            "STOCKS - stocks\n" +
     ...
     * StockLoopCapAdvisor (com.mycompany.orchestrator.tool.stock) is registered deeper in the
